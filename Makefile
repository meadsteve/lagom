...
benchmark:
	# --benchmark-compare=0001 --benchmark-compare-fail=mean:20%
	pipenv run pytest tests -m "benchmarking" -vv --benchmark-save=baseline --benchmark-max-time=10 --benchmark-disable-gc
